...
Project.create!(due_date: "10/4/2024", name: "Jones Wedding", kind: "wedding invites", template: false, complete: false,  user_id: 1)
Project.create!(due_date: "10/5/2025", name: "James Wedding", kind: "wedding invites", template: false, complete: false, user_id: 2)
